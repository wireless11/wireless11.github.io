...
//         wdate=wdate.substring(0, wdate.indexOf(" 오"));
         out.println("  <tr align=center><td>"+no+"</td><td>"+name+"</td><td><a href='viewboard.jsp?no="+no+"'>"+title+"</a></td><td>");

if (upfile1 != null && upfile1 !="") out.println("<a href='download.jsp?no="+no+"&upfile=upfile1'> <img src='disk.gif'></a>");
if (upfile2 != null && upfile2 !="") out.println("<a href='download.jsp?no="+no+"&upfile=upfile2'> <img src='disk.gif'></a>");

out.println("</td><td>"+wdate+"</td><td>"+hit+"</td></tr>");
